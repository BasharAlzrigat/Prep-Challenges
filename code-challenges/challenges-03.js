...
const cvFormatter = (arr) => {
  ...
  for (let i = 0; i < targeted.length; i++) {
    if (targeted[i].firstName !== null && targeted[i].lastName !== null) {
      wantedCvs[i] = { fullName: targeted[i].firstName + " " + targeted[i].lastName, tech: targeted[i].tech }
    } if (targeted[i].firstName === null && targeted[i].lastName !== null) {
      wantedCvs[i] = { fullName: targeted[i].lastName, tech: targeted[i].tech }
    } if (targeted[i].firstName !== null && targeted[i].lastName === null) {
      wantedCvs[i] = { fullName: targeted[i].firstName, tech: targeted[i].tech }
    }
  }
  return wantedCvs
};
